...
class FirebaseUpload {
  sendToServer() async {
    ...
    await uploadFirstPicture(pathImg, pathImg2, pathImg3);
  }

  Future uploadFirstPicture(String pathImg, String pathImg2,
      String pathImg3) async {
    ...
    await uploadSecondPicture(pathImg2, pathImg3);
  }
  ...
  Future uploadSecondPicture(String pathImg2, String pathImg3) async {
    ...
    await uploadThirdPicture(pathImg3);
  }
